...
stats_columns = [ "date", "channel_name", "video_id", "views", "likes", "comments"]  # adjust to your schema
...
video_master = pd.DataFrame(video_master, columns=video_columns)     #<----- chaanged here
